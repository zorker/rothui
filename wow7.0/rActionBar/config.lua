...
L.cfg.bar1 = {
  ...
  frameTemplate   = "SecureHandlerStateTemplate",
  frameVisibility = "[petbattle] hide; show",
  framePage       = "[vehicleui]vui; [possessbar]pb; [overridebar]ob; [shapeshift]ss; [bonusbar:1]bb1; [bonusbar:2]bb2; [bonusbar:3]bb3; [bonusbar:4]bb4; [bar:2]b2; [bar:3]b3; [bar:4]b4; [bar:5]b5; [bar:6]b6; [form]frm; [bar:1]b1; xx",
