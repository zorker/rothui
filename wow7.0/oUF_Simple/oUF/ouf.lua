...
--oUF:SpawnNamePlates
function oUF:SpawnNamePlates(styleName,namePrefix,nameplateOptionsFunc)
  ...
  NamePlateDriverFrame.UpdateNamePlateOptions = nameplateOptionsFunc or UpdateNamePlateOptions
  ...
  function NPEH:NAME_PLATE_UNIT_ADDED(event,unit)
    ...
    if not nameplate.unitFrame then
      ...
      nameplate.unitFrame = oUF:SpawnNamePlate(unit, namePrefix..nameplate:GetName(),nameplate)
