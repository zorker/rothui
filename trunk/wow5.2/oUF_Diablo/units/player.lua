  ...
  local createHealthPowerStrings = function(self)
    ...
    if self.cfg.health.text.alpha then
      hpval1:SetAlpha(self.cfg.health.text.alpha)
      hpval2:SetAlpha(self.cfg.health.text.alpha)
    end
    
    if self.cfg.health.text.mouseover then
      self:HookScript("OnEnter", function()
        UIFrameFadeIn(hpval1, 0.3, hpval1:GetAlpha(), 1)
        UIFrameFadeIn(hpval2, 0.3, hpval2:GetAlpha(), 1)
      end)
      self:HookScript("OnLeave", function()
        UIFrameFadeIn(hpval1, 0.2, hpval1:GetAlpha(), self.cfg.health.text.alpha)
        UIFrameFadeIn(hpval2, 0.2, hpval2:GetAlpha(), self.cfg.health.text.alpha)
      end)
    end
    ...
    if self.cfg.power.text.alpha then
      ppval1:SetAlpha(self.cfg.power.text.alpha)
      ppval2:SetAlpha(self.cfg.power.text.alpha)
    end
    
    if self.cfg.power.text.mouseover then
      self:HookScript("OnEnter", function()
        UIFrameFadeIn(ppval1, 0.3, ppval1:GetAlpha(), 1)
        UIFrameFadeIn(ppval2, 0.3, ppval2:GetAlpha(), 1)
      end)
      self:HookScript("OnLeave", function()
        UIFrameFadeIn(ppval1, 0.2, ppval1:GetAlpha(), self.cfg.power.text.alpha)
        UIFrameFadeIn(ppval2, 0.2, ppval2:GetAlpha(), self.cfg.power.text.alpha)
      end)
    end
