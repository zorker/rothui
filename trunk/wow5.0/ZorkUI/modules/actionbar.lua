...
lib:CreateZUIBorder(frame)
frame:SetZUIBorderColor(1,1,1,1)
...
local bar = CreateFrame("StatusBar", nil, UIP)
bar:SetSize(200,10)
bar:SetPoint("CENTER",0,-180)
lib:CreateZUIBackground(bar)
lib:CreateZUIBorder(bar,lib.mediaPath.."rothB-backdrop-border_3b_3s",8,3)
bar:SetMinMaxValues(0,1)
bar:SetValue(0.6)
bar:SetStatusBarTexture(lib.mediaPath.."statusbar")
bar:SetStatusBarColor(1,0,0)
bar:SetZUIBackgroundColor(.2,0,0,0.5)
bar:SetZUIBorderColor(.1,.1,.1)