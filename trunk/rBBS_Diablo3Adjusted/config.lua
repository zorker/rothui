  ...
  cfg.healthorb = {
    ...
    pos               = { a1="BOTTOM", a2="BOTTOM", af="UIParent", x=-383, y=4, },
    --strata      = "BACKGRROUND",
    --level       = 1,
  ...
  cfg.powerorb = {
    ...
    pos               = { a1="BOTTOM", a2="BOTTOM", af="UIParent", x=384, y=4, },
  } 
  ...
  cfg.angel = {
    ...
    level       = 5,
    scale       = 0.6,
    pos         = { a1="BOTTOM", a2="BOTTOM", af="UIParent", x=520, y=0, },
    texture     = {
  ...
  cfg.demon = {
    ...
    level       = 5,
    scale       = 0.6,
    pos         = { a1="BOTTOM", a2="BOTTOM", af="UIParent", x=-518, y=0, },
    texture     = {
