  ...
  local function cre_ring_holder(ring_config,self)
    ...
    if ring_config.global.holderscale ~= nil then
      f:SetScale(ring_config.global.holderscale)
